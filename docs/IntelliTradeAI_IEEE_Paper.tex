...
\item \textbf{Cross-Market Analysis}: Unified framework supporting 100+ cryptocurrencies across 12 sectors and comprehensive stock market coverage including all 11 GICS sectors.
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figure1_methodology_flow.png}}
...
Two primary classifiers form the ML ensemble. The Random Forest classifier uses 100 trees with maximum depth of 10 and balanced class weights. The XGBoost classifier uses 150 estimators with learning rate of 0.1 and maximum depth of 6.
...
\hline
Ensemble Size & 100 trees & 150 rounds \\
\hline
Regularization & Max depth=10 & L1/L2 reg. \\
\hline
Imbalance Handling & Class weights & Scale pos weight \\
\hline
Training Time & $\sim$45 seconds & $\sim$60 seconds \\
\hline
\end{tabular}
\label{tab:models}
\end{center}
...
Fig.~\ref{fig:loss} presents training and validation loss curves for both models across 100 epochs. The Random Forest model achieved convergence at epoch 45 with training loss of 0.312 and validation loss of 0.358. XGBoost demonstrated faster convergence at epoch 38 with validation loss of 0.341.

\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figure2_training_loss.png}}
\caption{Training and validation loss curves for Random Forest (left) and XGBoost (right) classifiers showing convergence behavior.}
\label{fig:loss}
\end{figure}
...
\hline
\textbf{Metric} & \textbf{Random Forest} & \textbf{XGBoost} & \textbf{Ensemble} \\
\hline
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\columnwidth]{figure3_backtest_returns.png}}
