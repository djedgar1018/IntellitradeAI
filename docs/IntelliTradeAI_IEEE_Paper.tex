...
Recent literature emphasizes the importance of multi-source signal integration. Yanxi et al. proposed fusion architectures that combine technical indicators with sentiment analysis, achieving improvement over single-source models \cite{b6}. Similarly, Lin et al. demonstrated that pattern recognition algorithms, when combined with ML predictions, achieve improved accuracy in directional forecasting \cite{b7}.
...
\bibitem{b4} L. Cheng, Y. Huang, and M. Wu, ``Financial time series forecasting with multi-modality graph neural network,'' \textit{Pattern Recognition}, vol. 121, art. no. 108215, pp. 1--12, Jan. 2022.
...
\bibitem{b6} W. Yanxi, L. Zhang, and H. Wang, ``Deep learning for financial time series prediction: A comprehensive review,'' \textit{Expert Systems with Applications}, vol. 184, art. no. 115436, pp. 1--18, Dec. 2021.
